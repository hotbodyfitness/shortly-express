...
describe('', function () {
  ...
  describe('Account Creation:', function () {
    ...
    it('logs the password to the database', function (done) {
      var options = {
        'method': 'POST',
        'uri': 'http://127.0.0.1:4568/signup',
        'json': {
      ...
      request(options, function (error, res, body) {
      db.knex.raw(`SELECT password FROM users WHERE password IN ('Svnh')`)
        .then(function (users) {
          //console.log('***************************************** \n', users);
    ...
    it('will not log in if the password does not match', function(done) {
      var options = {
        'method': 'POST',
        'uri': 'http://127.0.0.1:4568/login',
        'json': {
    ...
    it('will not log in if the username does not match', function(done) {
      var options = {
        'method': 'POST',
        'uri': 'http://127.0.0.1:4568/login',
        'json': {
